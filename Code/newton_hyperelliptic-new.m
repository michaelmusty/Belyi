...
intrinsic NewtonHyperelliptic(Gamma::GrpPSL2Tri : precstart := 40, precNewton := 1000, bound := 0) -> GrpPSL2Tri
  {wrapper...}
  // numerical data
...
intrinsic NewtonHyperellipticGenericBelyiMap(Gamma::GrpPSL2Tri) -> Any
